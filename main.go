...
func main() {
	...
	client, err := qdrant.NewClient(&qdrant.Config{
		Host: "93302b6c-e320-456a-a536-b645706481f1.europe-west3-0.gcp.cloud.qdrant.io",
		//Port:   6334,
		APIKey:                 dbKey,
		UseTLS:                 true,
		SkipCompatibilityCheck: true,
		GrpcOptions: []grpc.DialOption{
			grpc.WithAuthority("93302b6c-e320-456a-a536-b645706481f1.europe-west3-0.gcp.cloud.qdrant.io:6334"), // Explicitly set authority with port
		},
	})
	if err != nil {
		panic(err)
